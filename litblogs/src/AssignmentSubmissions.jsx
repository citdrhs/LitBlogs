...
const AssignmentSubmissions = () => {
  ...
  const loadData = async () => {
    try {
      ...
      const [assignmentsResponse, submissionsResponse] = await Promise.all([
        axios.get(`https://drhscit.org/dren/api/classes/${classId}/assignments`, {
          headers: { Authorization: `Bearer ${token}` }
        }),
        axios.get(`https://drhscit.org/dren/api/classes/${classId}/assignments/${assignmentId}/submissions`, {
          headers: { Authorization: `Bearer ${token}` }
        })
      ]);
  ...
  const submitReply = async (submissionId) => {
    ...
    try {
      ...
      await axios.post(
        `https://drhscit.org/dren/api/classes/${classId}/assignments/${assignmentId}/submissions/${submissionId}/replies`,
        { content },
        { headers: { Authorization: `Bearer ${token}` } }
      );
